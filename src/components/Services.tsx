  ...
  const services = [
    {
      ...
      description:
        'Te ayudamos a definir tu estrategia digital completa: desde la web hasta las redes sociales.',
      examples:
        'Sesiones 1 a 1, planes personalizados, seguimiento de resultados',
      featured: true
    },
    {
      icon: Globe,
      ...
      examples:
        'Ideal para: consultoras, profesionales independientes, pequeños comercios',
      featured: false
    },
    {
      icon: Code,
      ...
      description:
        'Herramientas web personalizadas para resolver necesidades específicas de tu negocio.',
      examples:
        'Calculadoras, formularios avanzados, sistemas de turnos, dashboards',
      featured: false
    },

    {
      ...
      description:
        'Gestión profesional de tus redes sociales: contenido, diseño, calendario y respuesta a mensajes.',
      examples:
        'Instagram, Facebook, LinkedIn - Contenido planificado que vende',
      featured: false
    },
  ]
