export const contentCreationCases = [
  ...
  },
  {
    ...
    instagramPosts: ['https://www.instagram.com/reel/DJ5ZDfFonEr/']
  },
  {
    id: 'federico-suarez',
...
export const appCases = [
  ...
  },
  {
    ...
    shortDescription:
      'Respondé 20 preguntas y descubrí en qué estado está tu negocio digitalmente. Resultado inmediato y personalizado.',
    longDescription:
      'El diagnóstico digital de KAI te permite evaluar en minutos el estado real de tu presencia online. Analizamos marca, web, redes sociales, métricas y automatización. Al final recibís un resultado personalizado con recomendaciones concretas según el estadio de tu negocio.',
    icon: 'clipboard',
    link: null,
    scrollTo: 'diagnostic'
  },
