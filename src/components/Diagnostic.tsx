...
const Diagnostic = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        { value: 'yes', label: 'Sí, aparezco en los primeros resultados', score: 2 },
    ...
    },
    {
      ...
      options: [
        { value: 'service', label: 'Servicio profesional (consultoría, abogado, etc.)', score: 0 },
  ...
  const getRecommendation = () => {
    ...
    if (score >= 3) {
      return {
        ...
        message: 'Tu presencia digital es sólida. Te recomendamos una auditoría para optimizar lo que ya tenés y llevarlo al siguiente nivel.',
      ...
      return {
        ...
        message: 'Tenés base, pero hay aspectos que mejorar. Una consultoría puede ayudarte a identificar qué necesitás primero.',
      ...
      if (!hasWebsite) {
        return {
          ...
          message: 'Necesitás establecer tu base digital. Un sitio web profesional + optimización para Google es tu prioridad.',
      ...
      return {
        ...
        message: 'Tenés web pero no te encuentran. Te recomendamos trabajar en tu posicionamiento y presencia online.',
  ...
  if (showResults) {
    const recommendation = getRecommendation();
    const IconComponent = recommendation.level === 'success' ? CheckCircle : AlertCircle;
    const iconColor = recommendation.level === 'success' ? 'text-green-500' : 
                      recommendation.level === 'warning' ? 'text-yellow-500' : 'text-red-500';
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="p-8 md:p-12 shadow-card text-center space-y-6">
              ...
              <div className="bg-secondary/50 rounded-xl p-6 space-y-2">
                <div className="text-sm font-medium text-muted-foreground">Te recomendamos:</div>
                <div className="text-xl font-bold text-primary">{recommendation.service}</div>
              </div>

              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <Button size="lg" onClick={handleWhatsApp} className="rounded-full">
                  <MessageCircle className="mr-2" />
                  Consultar por WhatsApp
                </Button>
                <Button size="lg" variant="outline" onClick={restart} className="rounded-full">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Diagnóstico <span className="bg-gradient-primary bg-clip-text text-transparent">digital</span>
            </h2>
          ...
          <Card className="p-8 md:p-12 shadow-card">
            ...
            <RadioGroup value={answers[currentStep]} onValueChange={handleAnswer} className="space-y-4">
            ...
            <div className="flex gap-4 mt-8">
              {currentStep > 0 && (
                <Button variant="outline" onClick={handlePrevious} className="flex-1 rounded-full">
                  Anterior
                </Button>
              )}
              <Button 
